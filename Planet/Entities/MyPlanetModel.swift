...
class MyPlanetModel: Codable, Identifiable, Hashable, ObservableObject {
    ...
    var template: Template? {
        TemplateBrowserStore.shared[templateName]
    }
    ...
    static func importBackup(from path: URL) throws -> MyPlanetModel {
    ...
    func savePublic() throws {
        ...
        let publicArticles: [PublicArticleModel] = try articles.map { article in
            ...
            let articleHTML = try template.render(article: publicArticle)
